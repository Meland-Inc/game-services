...
func QueryLandsHandler(
	...
	mapLandRecord, err := model.GetMapLandRecordByUser(input.UserId)
	if err != nil {
		respMsg.ErrorMessage = err.Error()
		return
	}
