...
func Init() (err error) {
	host := os.Getenv("MELAND_DEMO_DB_HOST")
	port := os.Getenv("MELAND_DEMO_DB_PORT")
	user := os.Getenv("MELAND_DEMO_DB_USER")
	pass := os.Getenv("MELAND_DEMO_DB_PASS")
	dbName := os.Getenv("MELAND_DEMO_DB_DATABASE")
